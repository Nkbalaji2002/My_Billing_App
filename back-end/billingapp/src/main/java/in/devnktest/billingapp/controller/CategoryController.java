package in.devnktest.billingapp.controller;
...
public class CategoryController {
    ...
    public CategoryResponse addCategory(@RequestPart("category") String categoryString, @RequestPart("file") MultipartFile file) {
        ...
        try {
            ...
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "Exception Occurred While parson the json : " + e.getMessage());
        }
    }
